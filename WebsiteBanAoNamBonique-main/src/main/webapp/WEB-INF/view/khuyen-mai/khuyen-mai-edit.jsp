    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Edit Khuyến Mãi</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            ...
                            <div class="form-container">
                                <form:form method="POST" action="/khuyen-mai/update/${khuyenMai.id}" modelAttribute="khuyenMai"
                                           class="custom-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input path="ngayBatDau" type="date" class="form-control" id="ngayBatDauInput" value="${khuyenMai.ngayBatDau}"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="ngayKetThuc">Ngày kết thúc:</label>
                                        <form:input path="ngayKetThuc" type="date" class="form-control" id="ngayKetThucInput" value="${khuyenMai.ngayKetThuc}"/>
                                    </div>
                                    <br>
