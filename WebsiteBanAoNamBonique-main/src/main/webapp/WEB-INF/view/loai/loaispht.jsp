            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Dong San Pham</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="form-container">
                                        <form:form method="POST" action="/loai-san-pham/add" modelAttribute="dongDoChoi">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                            <c:forEach items="${listLoai}" var="dong" varStatus="i">
                                                                <tr>
                                                                    <th scope="row">${i.count}</th>
                                                                    <td>${dong.ma}</td>
                                                                    <td>${dong.ten}</td>
                                                                    <td>${dong.trangThai == 3 ? "Hoạt động":"Ngừng hoạt động"}</td>
                                                                    <td>
                                                                        <a href="/loai-san-pham/view-update/${dong.id}"
                                                                           class="btn btn-sm btn-warning">Edit</a>

                                                                        <a class="btn btn-sm btn-warning"  onclick="return confirm('Bạn chắc chắn xóa chứ ?')" href="/loai-san-pham/delete/${dong.id}?trangThai=4">Delete</a>
