                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.html">Mau Sac</a>
                            <a class="nav-link" href="layout-sidenav-light.html">Dong san pham</a>
                            <a class="nav-link" href="layout-sidenav-light.html">Nha San Xuat</a>
                        </nav>
                    </div>
