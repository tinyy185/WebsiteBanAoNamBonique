                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="form-container">
                                        <form:form method="POST" action="/san-pham/add" modelAttribute="sanPham">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                            <c:forEach items="${ListSanPham}" var="ms" varStatus="i">
                                                                <tr>
                                                                    <th scope="row">${i.count}</th>
                                                                    <td>${ms.ma}</td>
                                                                    <td>${ms.ten}</td>
                                                                    <td>${ms.trangThai == 3 ? "Hoạt động" : "Ngừng hoạt động"}</td>
                                                                    <td>
                                                                    ...
                                                                    <td><a class="btn btn-sm btn-warning"
                                                                           ...
                                                                           href="/mau-sac/delete/${ms.id}?trangThai=4">Delete</a></td>
