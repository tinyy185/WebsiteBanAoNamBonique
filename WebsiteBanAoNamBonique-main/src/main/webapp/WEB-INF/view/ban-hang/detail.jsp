...
<%--                        </li>--%>
                        <li class="nav-item">
                            <!-- Link--><a class="nav-link" href="/checkLogin">Shop</a>
                        </li>
<%--                        <li class="nav-item">--%>
...
<%--                        </li>--%>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="/my-order/${appUser.userId}"> <i
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6">
                    ...
                    <div class="row m-sm-0">
                        <div class="col-sm-10 order-1 order-sm-2">
                            <a class="d-block"><img class="img-fluid w-100" src="../../../img/${chiTietSP.image}"
                                                    alt="..."></a>
                ...
                <div class="col-lg-6">
                    ...
                    <h1>${chiTietSP.ten}</h1>
                    <p class="text-muted lead">${chiTietSP.giaBan}</p>
                    <div class="row align-items-stretch mb-4">
                        <div class="col-sm-5 pr-sm-0">
                            ...
                            <%--                                <div class="quantity">--%>
                            <%--                                    <button class="dec-btn p-0"><i class="fas fa-caret-left"></i></button>--%>
                            <%--                                    <input class="form-control border-0 shadow-0 p-0" name="soLuong" type="number" value="1">--%>
                            <%--                                    <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button>--%>
                            <%--                                </div>--%>
                            <%--                            </div>--%>
                            <form action="/add-to-cart-in-detail/${chiTietSP.id}" method="post">
                                <input class="form-control p-0"
                                       style="border: 1px solid #ccc; box-shadow: none; width: 100px; text-align: center;"
                                       name="soLuong" type="number" value="1" inputmode="numeric">
                                <br>
                                <input type="hidden" name="userId" value="${appUser.userId}">
                                <button class="list-inline-item m-0 p-0" type="submit">
                                    <a class="btn btn-sm btn-dark">Add to cart</a></button>
                            </form>
                        </div>
                    ...
                    <ul class="list-unstyled small d-inline-block">
                        ...
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a
                                class="reset-anchor ms-2" href="#!">Demo Products</a></li>
            ...
            <div class="tab-content mb-5" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="p-4 p-lg-5 bg-white">
                        ...
                        <p class="text-muted text-sm mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
