...
<html>
  <head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="../../../img/anhhung1.jpg">
    <style>
      .img-fluid1{
        padding-top: 50px;
      }
  ...
  <body>
    <div class="page-holder">
      ...
      <!-- HERO SECTION-->
      <div class="container">
        <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background: url(../../../img/anhhung1.jpg)">
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6">
                <p class="text-muted small text-uppercase mb-2">New Inspiration 2023</p>
                <h1 class="h2 text-uppercase mb-3">20% off on new season</h1><a class="btn btn-dark" href="/checkLogin">Browse collections</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="pt-5">
          ...
          <div class="row">
            <div class="col-md-4"><a class="category-item" href="shop.html"><img class="img-fluid img-fluid1" src="../../../img/bannerQuan.jpg" alt=""/><strong class="category-item-title">Quan</strong></a>
            </div>
            <div class="col-md-4"><a class="category-item mb-4" href="shop.html"><img class="img-fluid" src="../../../img/BannerAo.jpg" alt=""/><strong class="category-item-title">Ao</strong></a><a class="category-item" href="shop.html"><img class="img-fluid" src="../../../img/bannerPhuKien.jpg" alt=""/><strong class="category-item-title">Mũ</strong></a>
            </div>
            <div class="col-md-4"><a class="category-item" href="shop.html"><img class="img-fluid img-fluid1" src="../../../img/bannerMu.jpg" alt=""/><strong class="category-item-title">Mu</strong></a>
            </div>
          </div>
        </section>
        <!-- TRENDING PRODUCTS-->
        <section class="py-5">
          <header>
            ...
            <h2 class="h5 text-uppercase mb-4">Top Sản phẩm mới về</h2>
          </header>
          <div class="row">
            <!-- PRODUCT-->
            <c:forEach items="${listChiTietSanPhamTop5.getContent()}" var="ctsp">
            <c:choose>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="mb-3 position-relative">
                 ...
                 <img class="img-fluid w-100" src="getimage/${ctsp.image}" alt="ahihi" ></a>
