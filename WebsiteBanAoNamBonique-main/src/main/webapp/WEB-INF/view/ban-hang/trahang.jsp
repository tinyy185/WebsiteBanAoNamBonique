...
<form method="post" action="/tra-hang-soluong">
    <input type="hidden" name="hoadonchitietId" value="${hd.id}">

    <label for="quantityToSubtract">Số Lượng Trả:</label>
    <input type="number" id="quantityToSubtract" name="quantityToSubtract" required><br>
