                ...
                <div class="modal-body p-0">
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0"><a class="glightbox product-view d-block h-100 bg-cover bg-center"
                                                        href="../../../boutique/img/product-5.jpg" data-gallery="gallery1"
            ...
            <div class="row">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                <th class="border-0 p-3" scope="col"><strong
                                        class="text-sm text-uppercase">Sản phẩm</strong></th>
                                <th class="border-0 p-3" scope="col"><strong
                                        class="text-sm text-uppercase">Giá</strong></th>
                                <th class="border-0 p-3" scope="col"><strong
                                        class="text-sm text-uppercase">Số lượng</strong></th>
                                <th class="border-0 p-3" scope="col"><strong
                                        class="text-sm text-uppercase">Tổng cộng</strong></th>
                            ...
                            <c:forEach items="${gioHangChiTiets}" var="gh">
                                ...
                                <tr>
                                    <th class="ps-0 py-3 border-light" scope="row">
                                        <div class="d-flex align-items-center"><a
                                                class="reset-anchor d-block animsition-link" href="detail.html">
                                            <img src="../../../img/${gh.idChiTietSanPham.image}" alt="..." width="70"/></a>
                                            <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link"
                                                                                    href="detail.html">${gh.idChiTietSanPham.idSanPham.ten } : ${   gh.idChiTietSanPham.ten}</a></strong>
                                                <h6>Size:${gh.idChiTietSanPham.idKichCo.ten}</h6>
                                                <h6>Màu Sắc:${gh.idChiTietSanPham.idMauSac.ten}</h6>
                                            </div>
                                        </div>
                                    </th>

                                    <td class="p-3 align-middle border-light">
                                        <p class="mb-0 small">${gh.donGia}</p>
                                    </td>
                                    <td class="p-3 align-middle border-light">
                                        <div class="border d-flex align-items-center justify-content-between px-3"><span
                                                class="small text-uppercase text-gray headings-font-family">${gh.soLuong}</span>
                                            <div class="quantity">
                                                <form action="/reduce-cart/${gh.idChiTietSanPham.id}" method="post">
                                                    <input type="hidden" name="userId" value="${appUser.userId}">
                                                    <button class="list-inline-item m-0 p-0" type="submit">-</button>
                                                </form>
                                                <input class="form-control form-control-sm border-0 shadow-0 p-0"
                                                       type="text" value="1"/>
                                                <form action="/add-to-cart/${gh.idChiTietSanPham.id}" method="post">
                                                    <input type="hidden" name="userId" value="${appUser.userId}">
                                                    <button class="list-inline-item m-0 p-0" type="submit">+</button>
                                                </form>
                                            </div>
                                    ...
                                    <td class="p-3 align-middle border-light">
                                        <p class="mb-0 small">${gh.donGia * gh.soLuong}</p>
                                    </td>
                                    <td>
                                        <form action="/remove-cart/${gh.idChiTietSanPham.id}" method="post">
                                            <input type="hidden" name="userId" value="${appUser.userId}">
                                            <button class="p-3 align-middle border-light" type="submit">
                                ...
                                <c:set var="productTotalPrice" value="${gh.donGia * gh.soLuong}"/>
                ...
                <div class="col-lg-4">
                    <div class="card border-0 rounded-0 p-lg-4 bg-light">
                        <div class="card-body">
                            <h5 class="text-uppercase mb-4">Tổng số giỏ hàng</h5>

                            <ul class="list-unstyled mb-0">
                                <li class="border-bottom my-2"></li>
                                <li class="d-flex align-items-center justify-content-between mb-4"><strong
                                        class="text-uppercase small font-weight-bold">Tổng tiền</strong><span>${totalPrice}</span>
                                </li>
                                <li>
                                </li>
                            </ul>
