        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                        ...
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            ...
                            <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../../view1/login.html">Login</a>
                                    <a class="nav-link" href="../../view1/register.html">Register</a>
                                    <a class="nav-link" href="../../view1/password.html">Forgot Password</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            ...
                            <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne"
                                 data-bs-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../../view1/401.html">401 Page</a>
                                    <a class="nav-link" href="../../view1/404.html">404 Page</a>
                    ...
                    <a class="nav-link" href="../../view1/charts.html">
                    ...
                    <a class="nav-link" href="/thong-ke/theo-thang">
                        <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                        Thống kê
                    </a>
                </div>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Top 10 sản phẩm bán chạy nhất theo tháng</h1>
                <br>

                <a href="/thong-ke/theo-ngay">Theo ngày</a>
                <a href="/thong-ke/theo-thang">Theo tháng</a>
                <a href="/thong-ke/theo-nam">Theo năm</a>
                <a href="/thong-ke/ban-cham-nhat-nam">Bán chậm nhất theo năm</a>


                <form method="get" action="/thong-ke/theo-thang" class="form-container">
                    <label for="selectedMonth" class="form-label">Chọn tháng:</label>
                    <input type="month" id="selectedMonth" name="selectedMonth" value="${now}" class="form-input"/>
...
<script>
    ...
    var data = [];
    <c:forEach items="${listTop10}" var="hd">
    labels.push("${hd[1]}"); // Tên sản phẩm
    data.push(${hd[3]}); // Tổng số lượng bán
    </c:forEach>
