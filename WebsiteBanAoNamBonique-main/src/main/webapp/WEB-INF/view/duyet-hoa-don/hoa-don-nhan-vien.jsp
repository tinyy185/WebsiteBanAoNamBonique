                                            ...
                                            <table class="table  table-sm table-hover ">
                                                ...
                                                <c:forEach items="${hoaDon}" var="hd">
                                                    <tr>
                                                        ...
                                                        <td>${hd.idTT.ten}</td>
                                                        <td>
                                                            <a href="/hoa-don/duyet/${hd.id}" class="btn btn-sm btn-primary ${hd.idTT.ten eq 'Đã nhận hàng' ? 'disabled' : ''}">Xác nhận</a>
                                                            <a href="/hoa-don/da-nhan/${hd.id}" class="btn btn-sm btn-primary ${hd.idTT.ten eq 'Chờ xác nhận' ? 'disabled' : ''}">Đã nhận hàng</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
