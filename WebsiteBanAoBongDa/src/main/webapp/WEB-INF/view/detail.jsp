            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand"
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <!-- Link--><a class="nav-link" href="/ban-hang">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown" href="#"
                            ...
                            <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown"><a
                                    ...
                                    class="dropdown-item border-0 transition-link" href="thanh-toan/checkout.jsp">Checkout</a>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="w3-container">
                        <form:form class="w3-container" action="/chi-tiet-san-pham/add" method="post"
                                   modelAttribute="chiTietSPDTO" enctype="multipart/form-data">
                    ...
                    <br>
                        <%--add-to cart--%>
                    <form action="/gio-hang/add-to-cart/${ctsp.id}" method="post">
