...
<div class="container" style="width:300px">
    ...
    <form:form action="/chi_tiet_sp/update" method="post" modelAttribute="ctsp">
        ...
        <c:forEach items="${idTenCauThu}" var="tct">
