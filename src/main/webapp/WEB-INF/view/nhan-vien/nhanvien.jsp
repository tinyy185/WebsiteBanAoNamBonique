...
<style>
    table {
        width: 100%; /* Đảm bảo bảng sử dụng toàn bộ chiều rộng của khung chứa */
    }

    td {
        max-width: 100px; /* Đặt chiều rộng tối đa cho mỗi ô */
        font-size: 9px;
    }
</style>
<body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <center>
                            ...
                            <div id="output"></div>
                            <br>
                            <button type="button" class="btn btn-primary" onclick="addToSql()">Thêm QR nhân viên</button>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" style="font-size: 8px;">Username</th>
                                                    <th scope="col" style="font-size: 8px;">Password</th>
                                                    <th scope="col" style="font-size: 8px;">Email</th>
                                                    <th scope="col" style="font-size: 8px;">cccd</th>
                                                    <th scope="col" style="font-size: 8px;">fullname</th>
                                                    <th scope="col" style="font-size: 8px;">birthdate</th>
                                                    <th scope="col" style="font-size: 8px;">gender</th>
                                                    <th scope="col" style="font-size: 8px;">addresses</th>
                                                    <th scope="col" style="font-size: 8px;">qrcodedate</th>
                                                    <th scope="col" style="font-size: 8px;">trang thai</th>
                                                    <th scope="col" style="font-size: 8px;">Actions</th>
                                                </tr>
                                                ...
                                                <c:forEach items="${listNhanVien}" var="nv" varStatus="i">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/nhan-vien/view-update/${nv.id}" class="btn btn-sm btn-warning">Edit</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
